    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" value="${modified.title}">
            </div>
        </div>
        <div class="col"></div>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <textarea class="form-control" rows="5" id="description" name="description">${modified.description}</textarea>
            </div>
        </div>
        <div class="col"></div>
