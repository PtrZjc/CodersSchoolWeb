...
<form action="/ManageUsers" method="post">
    <div class="row">
        <div class="col"></div>
        <div class="col"><h4>Modify user with id ${modified.id}</h4></div>
        <div class="col"></div>
    </div>
    <div class="row">
        <div class="col"></div>
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" name="username" value="${modified.username}">
            </div>
        </div>
        <div class="col"></div>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email"  value="${modified.email}">
            </div>
        </div>
        <div class="col"></div>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <select name="userGroupID" class="form-control" id="sel1" value="${modified.userGroup.name}">
                    <c:forEach items="${userGroups}" var="ug">
                        <c:choose>
                            <c:when test="${ug.id==modified.userGroup.id}">
                                <option selected value="${ug.id}">${ug.name}</option>
                            </c:when>
                            <c:otherwise>
